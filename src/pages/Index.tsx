...
export const Index:React.FC =memo(()=>{
  ...
  <div className="container md:px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-20">
      <h1 className="sm:text-4xl text-3xl font-medium title-font mb-2 text-gray-900">事例製品一覧</h1>
    </div>
        ...
        <tbody>
          <tr>
            ...
            <td className="w-10 text-center">
              <button className="bg-red-100">詳細</button>
            </td>
            <td className="w-10 text-center pb-0.5">
              <button className="bg-red-100">編集</button>
            </td>
          </tr>
          <tr>
